...
// Ερώτημα για προϊόντα της κατηγορίας 'Aleyria'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'aleyria'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Αλεύρια</title>
