...
// Ερώτημα για προϊόντα της κατηγορίας 'Kotopoylo'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'kotopoylo'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Φρέσκα Κοτόπουλα</title>
