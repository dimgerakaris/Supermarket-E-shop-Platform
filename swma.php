...
// Ερώτημα για προϊόντα της κατηγορίας 'swma'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'swma'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Φροντίδα Σώματος</title>
