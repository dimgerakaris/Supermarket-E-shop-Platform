...
// Ερώτημα για προϊόντα της κατηγορίας 'Nera'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'nera'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Νερά</title>
