...
// Ερώτημα για προϊόντα της κατηγορίας 'babyGala'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'babyGala'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Βρεφικά Γάλατα</title>
