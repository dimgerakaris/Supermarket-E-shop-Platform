...
// Ερώτημα για προϊόντα της κατηγορίας 'galKot'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'galKot'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Αλλαντικά Γαλοπούλας Και Κοτόπουλου</title>
...
<body>
    <section id="Products">
        <h1>Αλλαντικά Γαλοπούλας Και Κοτόπουλου</h1>
        <div class="products">
            <?php
