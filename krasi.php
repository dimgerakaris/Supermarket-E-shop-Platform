...
// Ερώτημα για προϊόντα της κατηγορίας 'Krasi'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'krasi'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Κρασιά</title>
