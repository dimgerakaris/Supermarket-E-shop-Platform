...
// Ερώτημα για προϊόντα της κατηγορίας 'GBaby'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'gBaby'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Βρεφικά Γιαούρτια</title>
