...
// Ερώτημα για προϊόντα της κατηγορίας 'ryzi'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'ryzi'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Ρύζια</title>
        ...
        <div class="products">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<p class="description">' . htmlspecialchars($row['description'], ENT_QUOTES) . '</p>';
