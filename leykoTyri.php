...
// Ερώτημα για προϊόντα της κατηγορίας 'LeykoTyri'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'leykoTyri'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Λευκά Τυριά</title>
