...
// Ερώτημα για προϊόντα της κατηγορίας 'synergaKatharismoy'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'synergaKatharismoy'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Σύνεργα Καθαρισμού</title>
