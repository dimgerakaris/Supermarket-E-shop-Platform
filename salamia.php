...
// Ερώτημα για προϊόντα της κατηγορίας 'salamia'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'salamia'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Σαλάμια</title>
