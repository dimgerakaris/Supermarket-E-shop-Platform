...
// Ερώτημα για προϊόντα της κατηγορίας 'xartika'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'xartika'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Χαρτικά</title>
