...
// Ερώτημα για προϊόντα της κατηγορίας 'boytyro'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'boytyro'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Βούτηρα</title>
