...
// Ερώτημα για προϊόντα της κατηγορίας 'Mosxari'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'mosxari'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Φρέσκα Μοσχάρια</title>
