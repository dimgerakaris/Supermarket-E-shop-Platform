...
// Ερώτημα για προϊόντα της κατηγορίας 'Kshroi Karpoi'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'kshroiKarpoi'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Ξηροί Καρποί</title>
