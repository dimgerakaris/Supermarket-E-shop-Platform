...
// Ερώτημα για προϊόντα της κατηγορίας 'babyFoods'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'babyFoods'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Βρεφικές Τροφές</title>
