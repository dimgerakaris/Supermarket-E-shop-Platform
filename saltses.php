...
// Ερώτημα για προϊόντα της κατηγορίας 'saltses'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'saltses'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Έτοιμες Σάλτσες</title>
