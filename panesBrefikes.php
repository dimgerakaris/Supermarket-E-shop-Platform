...
// Ερώτημα για προϊόντα της κατηγορίας 'panesBrefikes'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'panesBrefikes'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Βρεφικές Και Παιδικές πάνες, Μωρομάντιλα</title>
...
<body>
    <section id="Products">
        <h1>Βρεφικές Και Παιδικές πάνες, Μωρομάντιλα</h1>
        <div class="products">
            <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<img src="' . htmlspecialchars($row['image'], ENT_QUOTES) . '" alt="' . htmlspecialchars($row['name'], ENT_QUOTES) . '" class="product-img">';
