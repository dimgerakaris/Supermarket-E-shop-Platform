...
// Ερώτημα για προϊόντα της κατηγορίας 'Giaoyrtia'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'giaoyrtia'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Γιαούτρια</title>
