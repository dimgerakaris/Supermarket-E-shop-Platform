...
// Ερώτημα για προϊόντα της κατηγορίας 'sokolata'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'sokolata'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Σοκολάτες</title>
