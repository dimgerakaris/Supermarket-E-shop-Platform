...
// Ερώτημα για προϊόντα της κατηγορίας 'royxwn'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'royxwn'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Απορρυπαντικά Ρούχων</title>
