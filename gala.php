...
// Ερώτημα για προϊόντα της κατηγορίας 'gala'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'gala'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Γάλατα</title>
