...
// Ερώτημα για προϊόντα της κατηγορίας 'Malakia'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'malakia'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Μαλάκια</title>
