...
// Ερώτημα για προϊόντα της κατηγορίας 'piata'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'piata'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Απορρυπαντικά Πιάτων</title>
