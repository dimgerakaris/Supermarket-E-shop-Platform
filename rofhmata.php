...
// Ερώτημα για προϊόντα της κατηγορίας 'rofhmata'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'rofhmata'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Καφέδες Και Ροφήματα</title>
