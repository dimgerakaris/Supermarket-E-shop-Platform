...
// Ερώτημα για προϊόντα της κατηγορίας 'Anapsyktika'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'anapsyktika'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Αναψυκτικά</title>
