...
// Ερώτημα για προϊόντα της κατηγορίας 'Ntomatika'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'ntomatika'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Ντοματικά</title>
