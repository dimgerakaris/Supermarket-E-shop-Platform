...
// Ερώτημα για προϊόντα της κατηγορίας 'Ksyrisma'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'ksyrisma'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Είδη Ξυρίσματος Και After Shave</title>
...
<body>
    <section id="Products">
        <h1>Είδη Ξυρίσματος Και After Shave</h1>
        <div class="products">
            <?php
