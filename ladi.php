...
// Ερώτημα για προϊόντα της κατηγορίας 'Ladi'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'ladi'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Λάδια Και Ξύδια</title>
