...
// Ερώτημα για προϊόντα της κατηγορίας 'Arni'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'arni'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Φρέσκα Αρνιά Και Κατσίκια</title>
...
<body>
    <section id="Products">
        <h1>Φρέσκα Αρνιά Και Κατσίκια</h1>
        <div class="products">
            <?php
