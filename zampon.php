...
// Ερώτημα για προϊόντα της κατηγορίας 'zampon'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'zampon'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Ζαμπόν</title>
