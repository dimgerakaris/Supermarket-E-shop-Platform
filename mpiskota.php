...
// Ερώτημα για προϊόντα της κατηγορίας 'Mpiskota'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'mpiskota'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Μπισκότα</title>
