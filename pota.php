...
// Ερώτημα για προϊόντα της κατηγορίας 'pota'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'pota'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Ποτά</title>
