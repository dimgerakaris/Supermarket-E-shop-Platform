...
// Ερώτημα για προϊόντα της κατηγορίας 'proswpo'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'proswpo'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Φροντίδα Προσώπου</title>
