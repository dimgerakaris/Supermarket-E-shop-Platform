...
// Ερώτημα για προϊόντα της κατηγορίας 'psaria'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'psaria'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Ψάρια</title>
