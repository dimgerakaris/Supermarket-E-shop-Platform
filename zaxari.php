...
// Ερώτημα για προϊόντα της κατηγορίας 'zaxarh'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'zaxarh'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Ζάχαρη</title>
