...
// Ερώτημα για προϊόντα της κατηγορίας 'Krema'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'krema'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Κρέμες Γάλατος</title>
