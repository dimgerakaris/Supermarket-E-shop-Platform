...
// Ερώτημα για προϊόντα της κατηγορίας 'snaks'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'snaks'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Σνάκς</title>
