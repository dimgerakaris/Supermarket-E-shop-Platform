...
// Ερώτημα για προϊόντα της κατηγορίας 'zymarika'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'zymarika'";
