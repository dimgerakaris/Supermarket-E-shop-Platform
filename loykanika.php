...
// Ερώτημα για προϊόντα της κατηγορίας 'Loykanika'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'loykanika'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Λουκάνικα</title>
