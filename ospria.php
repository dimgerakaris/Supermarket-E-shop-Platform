...
// Ερώτημα για προϊόντα της κατηγορίας 'Ospria'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'ospria'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Όσπρια</title>
