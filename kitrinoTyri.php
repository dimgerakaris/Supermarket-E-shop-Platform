...
// Ερώτημα για προϊόντα της κατηγορίας 'Kitrino Tyri'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'kitrinoTyri'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Κίτρινα Τυριά</title>
