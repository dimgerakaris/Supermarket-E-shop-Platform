...
// Ερώτημα για προϊόντα της κατηγορίας 'dimitriaka'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'dhmhtriaka'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Δημητριακά Και Μπάρες</title>
