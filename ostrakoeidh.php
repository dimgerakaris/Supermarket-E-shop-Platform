...
// Ερώτημα για προϊόντα της κατηγορίας 'ostrakoeidh'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'ostrakoeidh'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Οστρακοειδή</title>
