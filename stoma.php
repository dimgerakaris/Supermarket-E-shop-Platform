...
// Ερώτημα για προϊόντα της κατηγορίας 'stoma'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'stoma'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Στοματική Υγιεινή</title>
