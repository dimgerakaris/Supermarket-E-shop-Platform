...
// Ερώτημα για προϊόντα της κατηγορίας 'Mpyra'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'mpeikon'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Μπέικον</title>
