...
// Ερώτημα για προϊόντα της κατηγορίας 'Katharistika'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'katharistika'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Καθαριστικά Γενικής Χρήσης</title>
...
<body>
    <section id="Products">
        <h1>Καθαριστικά Γενικής Χρήσης</h1>
        <div class="products">
            <?php
