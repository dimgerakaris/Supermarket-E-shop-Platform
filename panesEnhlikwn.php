...
// Ερώτημα για προϊόντα της κατηγορίας 'panesEnhlikwn'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'panesEnhlikwn'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Σερβιέτες Και Πάνες ενηλίκων</title>
...
<body>
    <section id="Products">
        <h1>Σερβιέτες Και Πάνες ενηλίκων</h1>
        <div class="products">
            <?php
