...
// Ερώτημα για προϊόντα της κατηγορίας 'Ayga'
$sql = "SELECT id, name, image, price, description, stock FROM products WHERE category = 'ayga'";
...
<head>
    ...
    <title>Τα Προϊόντα μας - Αυγά</title>
